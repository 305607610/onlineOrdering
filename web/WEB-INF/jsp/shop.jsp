...
<section class="Shop-index">
    <article>
        <div class="shopinfor">
            <div class="title">
                <img src="${pageContext.request.contextPath}/static/upload/wpjnewlogo.jpg" class="shop-ico">
                <span>含山路外婆家</span>
                <span>
     ...
     <img src="${pageContext.request.contextPath}/static/images/star-off.png">
            ...
            <div class="imginfor">
                <div class="shopimg">
                    <img src="${pageContext.request.contextPath}/static/upload/cc.jpg" id="showimg">
                    <ul class="smallpic">
                        <li><img src="${pageContext.request.contextPath}/static/upload/cc.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
                    </ul>
                </div>
                <div class="shoptext">
                    ...
                    <div class="otherinfor">
                        <a href="#" class="icoa"><img src="${pageContext.request.contextPath}/static/images/collect.png">收藏店铺（1293）</a>
                ...
                <div class="menutab-wrap">
                    <a name="ydwm">
                        ...
                        <div class="menutab show">
                            <ul class="products">
                                <li>
                                    <a href="detailsp.html" title="酸辣土豆丝">
                                        <img src="${pageContext.request.contextPath}/static/upload/01.jpg" class="foodsimgsize">
                                    </a>
                                    <a href="#" class="item">
                                        <div>
                                            <p>酸辣土豆丝</p>
                                ...
                                <li>
                                    <a href="detailsp.html" title="酸辣土豆丝">
                                        <img src="${pageContext.request.contextPath}/static/upload/02.jpg" class="foodsimgsize">
                                    </a>
                                    <a href="#" class="item">
                                        <div>
                                            <p>酸辣土豆丝</p>
                                ...
                                <li>
                                    <a href="detailsp.html" title="酸辣土豆丝">
                                        <img src="${pageContext.request.contextPath}/static/upload/04.jpg" class="foodsimgsize">
                                    </a>
                                    <a href="#" class="item">
                                        <div>
                                            <p>酸辣土豆丝</p>
                                ...
                                <li>
                                    <a href="detailsp.html" title="酸辣土豆丝">
                                        <img src="${pageContext.request.contextPath}/static/upload/03.jpg" class="foodsimgsize">
                                    </a>
                                    <a href="#" class="item">
                                        <div>
                                            <p>酸辣土豆丝</p>
                    ...
                    <div class="menutab">
                        <div class="shopdetails">
                            <div class="shopmaparea">
                                <img src="${pageContext.request.contextPath}/static/upload/testimg.jpg"><!--此处占位图调用动态地图后将其删除即可-->
                            </div>
    ...
    <aside>
        <div class="cart" id="Topcart">
            <span class="Ctitle Block FontW Font14"><a href="cart.html">我的购物车</a></span>
        ...
        <div class="Nearshop">
            ...
            <ul>
                <li>
                    ...
                    <p>
                        <span class="shopname" title="动态调用完整标题"><a href="detailsp.html" title="肯德基">肯德基</a></span>
        ...
        <div class="History">
            ...
            <ul>
                <li>
                    <a href="detailsp.html" title="清真川菜馆"><img src="${pageContext.request.contextPath}/static/upload/cc.jpg"></a>
                    <p>
                        <span class="shopname" title="动态调用完整标题"><a href="detailsp.html" title="正宗陕北小吃城">正宗陕北小吃城</a></span>
