...
<section class="Psection MT20">
    <article class="A-left Overflow">
        <h1 class="Font16 FontW classtitle">企业新闻</h1>
        <div class="Articlelist Overflow">
            <p class="p1 FontW Font14"><i class="Blockinline"></i><a href="article_read.html" title="这里是文章标题">管理企业最难的应该就是人心</a><time>2014-09-23</time></p>
            ...
            <p class="p1 FontW Font14"><i class="Blockinline"></i><a href="article_read.html" title="这里是文章标题">HTML5上传图片之FileReader的使用方法</a><time>2014-09-23</time></p>
            ...
            <p class="p1 FontW Font14"><i class="Blockinline"></i><a href="article_read.html" title="这里是文章标题">calc()在css3中实际应用示例</a><time>2014-09-23</time></p>
            ...
            <p class="p1 FontW Font14"><i class="Blockinline"></i><a href="article_read.html" title="这里是文章标题">CSS之content的实际应用</a><time>2014-09-23</time></p>
            ...
            <p class="p1 FontW Font14"><i class="Blockinline"></i><a href="article_read.html" title="这里是文章标题">“请在微信客户端打开链接”JavaScript判断</a><time>2014-09-23</time></p>
    ...
    <aside class="A-right Overflow">
        <div class="AAlist">
            ...
            <ul>
                <li><a href="/web/toArticle_read" title="这里是推荐某分类文章">这里是推荐某分类文章...</a></li>
            </ul>
        </div>
        <!--广告位-->
        <div style="margin:8px 0;">
            <a href="#"><img src="${pageContext.request.contextPath}/static/upload/ggw.jpg"></a>
        </div>
    </aside>
</section>
<!--End content-->
