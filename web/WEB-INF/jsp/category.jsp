...
<section class="Psection">
        ...
        <ul>
            <li>
                <a href="detailsp.html" title="酸辣土豆丝">
                    <img src="${pageContext.request.contextPath}/static/upload/05.jpg">
            ...
            <li>
                <a href="detailsp.html" title="酸辣土豆丝">
                    <img src="${pageContext.request.contextPath}/static/upload/06.jpg">
                    <p class="Overflow">酸辣土豆丝</p>
                    <p class="Overflow">赠送：<span class="CorRed Font16">2</span>积分<i></i></p>
                    <p class="Overflow">好味来快餐连锁店</p>
                    <p class="Overflow">地址：莲湖区土门十字往西100米</p>
            ...
            <li>
                <a href="detailsp.html" title="酸辣土豆丝">
                    <img src="${pageContext.request.contextPath}/static/upload/04.jpg">
                    <p class="Overflow">酸辣土豆丝</p>
                    <p class="Overflow">赠送：<span class="CorRed Font16">2</span>积分<i></i></p>
                    <p class="Overflow">好味来快餐连锁店</p>
                    <p class="Overflow">地址：莲湖区土门十字往西100米</p>
            ...
            <li>
                <a href="detailsp.html" title="酸辣土豆丝">
                    <img src="${pageContext.request.contextPath}/static/upload/03.jpg">
                    <p class="Overflow">酸辣土豆丝</p>
                    <p class="Overflow">赠送：<span class="CorRed Font16">2</span>积分<i></i></p>
                    <p class="Overflow">好味来快餐连锁店</p>
                    <p class="Overflow">地址：莲湖区土门十字往西100米</p>
    ...
    <aside class="CateR">
        <!--广告位或推荐位-->
        <div>
            <a href="#"><img src="${pageContext.request.contextPath}/static/upload/ad.jpg"></a>
        </div>
        <div class="Hot_shop">
            <span class="Hshoptile Font14 FontW Block">热门商家</span>
            <ul>
                <li>
                    <a href="shop.html" title="好味来快餐连锁店"><img src="${pageContext.request.contextPath}/static/upload/cc.jpg"></a>
                    <p class="Font14 FontW Overflow Lineheight35"><a href="shop.html" title="好味来快餐连锁店">好味来快餐连锁店</a></p>
                    <p class="Lineheight35 Overflow"><span title="通过动态控制地址的字符数量...">地址：西安市莲湖区土门新市场斜对面...</span></p>
                </li>
                <li>
                    <a href="shop.html" title="好味来快餐连锁店"><img src="${pageContext.request.contextPath}/static/upload/dd.jpg"></a>
                    <p class="Font14 FontW Overflow Lineheight35"><a href="shop.html" title="好味来快餐连锁店">好味来快餐连锁店</a></p>
                    <p class="Lineheight35 Overflow"><span title="通过动态控制地址的字符数量...">地址：西安市莲湖区土门新市场斜对面...</span></p>
                </li>
                <li>
                    <a href="shop.html" title="好味来快餐连锁店"><img src="${pageContext.request.contextPath}/static/upload/ee.jpg"></a>
                    <p class="Font14 FontW Overflow Lineheight35"><a href="shop.html" title="好味来快餐连锁店">好味来快餐连锁店</a></p>
                    <p class="Lineheight35 Overflow"><span title="通过动态控制地址的字符数量...">地址：西安市莲湖区土门新市场斜对面...</span></p>
                </li>
                <li>
