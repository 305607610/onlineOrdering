    ...
    <div class="Reserve Overflow">
        <form action="#">
            <table>
                ...
                <th>小计</th>
                <tr>
                    <td><a href="/food/toDetailsp" title="酸辣土豆丝" targe="_blank">酸辣土豆丝</a></td>
                    <td><b>1</b></td>
                    <td>￥5.90</td>
                    <td><b>￥5.90</b></td>
                </tr>
                <tr>
                    <td><a href="/food/toDetailsp" title="鱼香肉丝">鱼香肉丝</a></td>
                    <td><b>2</b></td>
                    <td>￥6.00</td>
                    <td><b>￥12.00</b></td>
                </tr>
...
<section class="Psection MT20 Textcenter"  >
    ...
    <p class="Font14 Lineheight35 FontW">请在2014-09-24 11:30 ~ 2014-09-24 14:30进店[ <a href="shop.html">好味来快餐店</a> ]就餐</p>
    ...
    <p><button type="button" class="Submit"><a href="user_center.html">进入用户中心</a></button></p>
</section>
<!--End content-->
